...
let openMessageBox = setInterval(function() {
  ...
  console.log(
    "Opening message box of " +
      listOfRecentContacts[count].getElementsByClassName("_1wjpf")[0].title +
      " -> " +
      count
  );
  ...
  let textToSend =
    "Hello " +
    listOfRecentContacts[count - 1].getElementsByClassName("_1wjpf")[0].title +
    ". I hope you are doing great. This is an autogenerated message from Pk. Please Ignore. Do not reply.";
  // let textToSend = "Hello guys, Ignore this message I am testing out a program.";
